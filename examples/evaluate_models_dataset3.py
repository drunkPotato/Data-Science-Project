#!/usr/bin/env python3
"""
Evaluate DeepFace, FER, and Custom-ResNet18 models on Emotion Dataset 3 test set
"""
...
def main():
    ...
    output_file = output_dir / "dataset3_model_comparison.csv"
    ...
    if not test_csv.exists():
        ...
        print("Please ensure emotion dataset 3 is properly set up.")
        return

    # Load test labels
    print("Loading test labels from CSV...")
    ...
    print("\n" + "="*70)
    print("MODEL EVALUATION SUMMARY - EMOTION DATASET 3 TEST SET")
    print("="*70)
    ...
    print("  python examples/visualize_dataset3_results.py")
    print("="*70)
